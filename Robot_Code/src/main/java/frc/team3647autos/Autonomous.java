...
public class Autonomous 
{
    ...
    public static void twoCubeSwitch(Encoders enc, NavX gyro)
    {
    ...
    public static void leftSide2Switch(Encoders enc, NavX gyro)
    {
        enc.setEncoderValues();
        gyro.setAngle();
        switch(currentState)
    ...
    public static void jankOppositeScale(Encoders enc, NavX gyro)
    {
        enc.setEncoderValues();
        gyro.setAngle();
        switch(currentState)
    ...
    public static void sharpOppositeScale(Encoders enc, NavX gyro)
    {
        enc.setEncoderValues();
        gyro.setAngle();
        switch(currentState)
    ...
    public static void switchFromMiddle(Encoders enc, NavX gyro)
    {
        enc.setEncoderValues();
        gyro.setAngle();
        switch(currentState)
